...
*/
//div.b-boast-list__item:nth-child(2)
//div.b-boast-list__item:nth-child(3)
...
/*$a="div.b-boast-list__item:nth-child() ";
//    echo $document;
$GLOBALS['total']=$main_count=$document->find($str=str_replace('>', '', $a) )->count();

echo "Count is : ".$GLOBALS['total']."<br>";
*/

/*for ($i=1; $i <= $main_count-$main_count+1; $i++) { 
  # code...
$a_main="div.b-boast-list__item:nth-child(".$i.") a";
...
$a="div.b-boast-list__item:nth-child(".$i.") img";
$el=$document->find($str=str_replace('>', '', $a) );
$pq=pq($el);
//echo $pq->attr('src');
$res['src']=$GLOBALS['curenhost']. $pq->attr('src');
...
//writetodb2((string)$date_publish,(string)$time_publish, (string)$type,(string) $description,(string) $price, $region, (string)$punct, (string)$street,(string) $bild,(string) $metro,(string) $tometrowalk, (string)$tometrocar, (string)$square, (string)$floar,(string) $floars, (string)$totalroom, (string)$rooms,(string) $name,(string) $fhone, (string)$foto,(string) $linke, (string)$maya,(string) $mayb,(string) $mayc, (string)$mayd, (string)$maye, (string)$mayf, (string)$mayg );
